...
this.dismissDelay = 8e3, this.autoDismissTypes = [ "info", "success" ], this.hiddenTypes = [ "success" ], this.$get = function() {
var notifications = [], dismissDelay = this.dismissDelay, autoDismissTypes = this.autoDismissTypes, hiddenTypes = this.hiddenTypes, notificationHiddenKey = function(notificationID, namespace) {
...
(isTypeHidden(notification) || notificationID && isNotificationPermanentlyHidden(notificationID, namespace)) && (notification.hidden = !0), notifications.push(notification);
...
}, isTypeHidden = function(notification) {
